...
<p align="center"><b>Wordline和Bitline是微观/电路上连接每个内存单元，从而构成"缓存行"和"操作列"的结构</b></p>
...
**MSI主板设置图例：**
![MSI mobo timing exp](MSI_GSkill_F5-6400J3239G16G_Subtimi.png)
...
!!!
 ...
 - **超频前：**
![BeforeOC.png](2023-06/BeforeOC.png)
 - **超频后：**
![AfterOC.png](2023-06/AfterOC.png)
